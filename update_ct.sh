...
echo
echo "------------------------------------------------------------"
echo "3/7  Updating NWS forecast..."
echo "------------------------------------------------------------"
...
echo
echo "------------------------------------------------------------"
echo "4/7  Running Hero Dirt v2 beta..."
echo "------------------------------------------------------------"
...
echo
echo "------------------------------------------------------------"
echo "5/7  Building Connecticut trail forecast..."
echo "------------------------------------------------------------"
...
echo
echo "------------------------------------------------------------"
echo "6/7  Building Connecticut Explorer..."
echo "------------------------------------------------------------"
...
# ============================================================
# 5. UPDATE GITHUB PAGES FILES
# ============================================================

echo
echo "------------------------------------------------------------"
echo "7/7  Updating GitHub Pages..."
echo "------------------------------------------------------------"
