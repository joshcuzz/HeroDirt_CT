...
"""
Hero Dirt Forecast
Refined whole-domain tread <-> shallow upward-exchange sensitivity.

Purpose
-------
The three-layer model allows:

    0-2 cm tread
    2-5 cm shallow
    5-20 cm deep

The tread can dry too strongly relative to the shallow layer.
This experiment allows mass-conserving upward moisture exchange
when:

    theta_shallow > theta_tread

The difference relaxes exponentially with timescale tau.

Refined test:
    tau = 2, 4, 6, 8, 12 hours
...
-------
output/diagnostics/
    upward_exchange_refined_sweep.csv

output/figures/
    upward_exchange_refined_domain_F.png
    upward_exchange_refined_domain_score.png
    upward_exchange_refined_hotspot_F.png
"""
...
if len(
    ...
    raise RuntimeError(
        "No MRMS fields found in analysis period."
    )
...
print(
    " HERO DIRT REFINED UPWARD-EXCHANGE SWEEP"
)
print(
    "============================================"
)
...
def upward_exchange(
    ...
    # Effective storage depth for two-layer equilibration.
    ...
    # Exact exponential relaxation fraction.
    ...
    # --------------------------------------------------------
    # Cannot remove water below shallow-layer WP
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Cannot fill tread above saturation
    # --------------------------------------------------------
...
print(
    " tau[h]   meanF  meanH  VeryDry    Dry   Good   Hero   Wet TooWet hotspotF"
)
...
for R in results:
    ...
    print(
        ...
        f"{R['hero_pct']:6.1f}% "
        f"{R['wet_pct']:5.1f}% "
        f"{R['too_wet_pct']:6.1f}% "
        f"{R['hotspot_final_F']:8.3f}"
    )
...
ax.set_title(
    "Hero Dirt — Refined Upward Exchange"
)
...
ax.set_title(
    "Hero Dirt — Refined Domain Score"
)
...
print(
    " REFINED UPWARD-EXCHANGE SWEEP COMPLETE"
)
print(
    "============================================"
)
