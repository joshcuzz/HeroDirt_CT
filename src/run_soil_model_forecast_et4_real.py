...
CURRENT_DIR = (
    ROOT
    / "output/current_forecast_et4_real"
)

FORECAST_DIR = (
    ROOT
    / "output/forecast_forecast_et4_real"
)
...
# Preserve the actual current state before forecast integration.
...
# Forecast-only tread drying sensitivity.
# Analysis / MRMS replay uses baseline ET = 2.5 mm/day.
ET_TREAD_BASE_DAY = 4.0
