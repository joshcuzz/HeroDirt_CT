...
CURRENT_FILE = (
    ROOT
    / "output/current_v2_penman_k050/HeroDirt_current_state.npz"
)
...
<span style="
    ...
    font-size:12px;
">
Experimental trail-moisture forecast for the
...
to estimate trail-surface moisture across the San Gabriel Mountains.
...
forecasts including
<b>air temperature, relative humidity, and 6-hour precipitation</b>.
</p>
