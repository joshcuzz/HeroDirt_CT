...
CURRENT_DIR = (
    ROOT
    / "output/current_drydown_et4"
)

FORECAST_DIR = (
    ROOT
    / "output/forecast_drydown_et4"
)
...
#
# Analysis / MRMS replay used the baseline 2.5 mm/day.
# Change the reference tread drying rate only after the
# current post-storm state has been established.
# ============================================================
